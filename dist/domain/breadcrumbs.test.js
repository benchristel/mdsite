...
test("htmlBreadcrumb", {
    "is empty on the top-level index page"() {
        ...
        expect(htmlBreadcrumb(of("/index.html"), project), is, `<nav aria-label="Breadcrumb" class="mdsite-breadcrumb"></nav>`);
    },
    "displays the title of the parent index page"() {
        ...
        expect(htmlBreadcrumb(of("/leaf.html"), project), contains, `<a href="index.html">The Index Page</a>`);
    },
    "creates multiple breadcrumbs for a file in a directory"() {
        ...
        expect(htmlBreadcrumb(of("/tree/leaf.html"), project), contains, `<a href="../index.html">The Index Page</a>` +
